...
name = "Hartford"
dir_path = "S:\Projects\\1940Census\\Block Creation\\%s\\" % (name)
...
reference_data = dir_path + name + "_1930_stgrid_edit.shp' 'Primary Table'"
grid = dir_path + name + "_1930_stgrid_edit.shp"
dissolve_grid = dir_path + name + "_1930_stgrid_Dissolve_2.shp"
split_grid = dir_path + name + "_1930_stgrid_Split_2.shp"
pblocks = dir_path + name + "_1930_Pblk_2.shp"
in_field_map='''
