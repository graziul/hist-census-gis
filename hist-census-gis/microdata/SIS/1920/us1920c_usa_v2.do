...
*this is a modified version of a script from ipums to build our 1920 data for further analysis
*last revised by NF c. April 2017, cosmetic revisions 13 July 2017
...
quietly infix                      ///
  ...
  str     rectypep      1-1        ///
  str     us1920c_0042  2144-2223  ///
  str     us1920c_0043  2224-2255  ///
  using `"us1920c_usa.dat"'
gen  _line_num = _n
drop if rectype != `"H"'
sort _line_num
...
label var indstr       `"Industry, alphabetic string"'
...
label define mortgage_lbl 2 `"Check mark on manuscript (probabably yes)"', add
...
label define mortgage_lbl 8 `"Illegible or uninterpretable"', add
label define mortgage_lbl 9 `"Missing"', add
...
label define enumdist_lbl 0    `"0"'
label define enumdist_lbl 9999 `"9999"', add
label values enumdist enumdist_lbl
...
label var us1920c_0042 `"Street address (80 characters)"'
label var us1920c_0043 `"Street address"'

export delimited using "/home/s4-data/LatestCities/1920/raw/SIS/us1920out.txt", delimiter("|") replace
*erase __temp_ipums_hier_H.dta
*erase __temp_ipums_hier_P.dta
